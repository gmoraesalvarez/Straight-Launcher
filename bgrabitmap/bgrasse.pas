...
type
  ...
  procedure Normalize3D_128(var v: TPoint3D_128); overload;
  procedure Normalize3D_128(var v: TPoint3D_128; out SqLen: single); overload;
  procedure Normalize3D_128_Aligned(var v: TPoint3D_128);
  procedure VectProduct3D_128(const u,v: TPoint3D_128; out w: TPoint3D_128);
  operator * (const v1,v2: TPoint3D_128): single;
  operator * (const v1: TPoint3D_128; const factor: single): TPoint3D_128;
  operator + (const v1,v2: TPoint3D_128): TPoint3D_128;
  procedure Add3D_Aligned(var dest: TPoint3D_128; const src: TPoint3D_128);
  operator - (const v1,v2: TPoint3D_128): TPoint3D_128;
...
@no_sse:
  ...
  db $d9, $40, $04 //flds [eax+4]
  db $d8, $4a, $04 //fmuls [edx+4]
  faddp st(1)

  db $d9, $40, $08 //flds [eax+8]
  db $d8, $4a, $08 //fmuls [edx+8]
  faddp st(1)

  db $d9, $40, $0C //flds [eax+12]
  db $d8, $4a, $0C //fmuls [edx+12]
  faddp st(1)

  db $d9, $5d, $fc //fstps [ebp-4]
...
procedure Normalize3D_128(var v: TPoint3D_128);
var len: single;
begin
  {$ifdef CPUI386}
    if UseSSE then
...
procedure Normalize3D_128(var v: TPoint3D_128; out SqLen: single);
var InvLen: single;
begin
  {$ifdef CPUI386}
    if UseSSE then
