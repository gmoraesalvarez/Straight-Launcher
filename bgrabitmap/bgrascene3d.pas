...
type
  ...
  protected
    ...
    procedure UseMaterial(material: string; face: IBGRAFace3D); virtual;
...
{$hints off}
procedure TBGRAScene3D.UseMaterial(material: string; face: IBGRAFace3D);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        UseMaterial(materialname,result.AddFace(slice(vertices,NbVertices)));
      end;
    end;
  end;
  closefile(t);
...
var
  ...
  begin
    ...
    begin
      ...
      begin
        FObjects[i].LightingNormal := Self.DefaultLightingNormal;
    ...
    for i := 0 to FObjectCount-1 do
      ...
      begin
        ...
        begin
          LFaces[LFaceIndex] := TBGRAFace3D(Face[j].GetAsObject);
          inc(LFaceIndex);
        end;
      end;
  end;
...
var
  ...
  begin
     ...
     begin
       ...
       if AAntialiasingMode = am3dMultishape then //high-quality antialiasing
       begin
         if LTexture <> nil then
         begin
...
begin
  ...
  if AAntialiasingMode = am3dResample then
  begin
    DrawWithResample;
    exit;
  end;
